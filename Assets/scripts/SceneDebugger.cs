...
#pragma warning restore CS0618 // Type or member is obsolete
                ...
                if (isOn)
                {
                    if (!_globalMeshEffectMesh)
                    {
                        ...
                        {
                            _globalMeshEffectMesh.MeshMaterial1 = visualHelperMaterial;
                            _globalMeshEffectMesh.MeshMaterial2 = visualHelperMaterial; // Assuming you want to use the same material for both
                        }
                ...
                else
                {
                    ...
                    _globalMeshEffectMesh.ToggleEffectMeshVisibility(false, filter, _globalMeshEffectMesh.MeshMaterial1); // Use MeshMaterial1 for the fallback
                }
            }
            catch (Exception e)
            {
